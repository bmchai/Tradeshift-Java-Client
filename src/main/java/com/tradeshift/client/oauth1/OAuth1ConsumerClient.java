...
public class OAuth1ConsumerClient extends OAuth1Client {
    ...
    public static OAuth1ConsumerClient of(JerseyClient client, String consumerKey, String consumerSecret, 
    ...
    protected OAuth1ConsumerClient(JerseyClient client, String consumerKey, String consumerSecret, 
